package Serie1.Exercicios.Ex1;


import Serie1.Exercicios.Ex2.newFile;
...
public class Exercicio1 {
    ...
    //Exercicio 1
    public static Map<Byte, Double> calculateFreq(Map<Byte, Integer> mapInfo){
    ...
    //Exercicio 1
    public static float calculateEntorp(Map<Byte, Double> mapFreq) {
        float ret= 0;
